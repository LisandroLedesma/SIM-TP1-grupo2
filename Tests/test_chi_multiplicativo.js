const buttonTestM = document.getElementById("btnTestM");
...
const testM = () => {
    const select = document.getElementById("intM");
...
const generarTablaM = (filas) => {
    const eGridDiv = document.querySelector("#gridTestM");
...
const generarHistogramaM = (filas, paso) => {
    ...
    let layout = {
        title: "Distribución de frecuencia (método multiplicativo)",
        barmode: "overlay",
